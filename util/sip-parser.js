import { ALLOW, ALLOWEVENTS, CALLID, CONTACT, CONTENT_LENGTH, CONTENT_TYPE, CSEQ, EXPIRES, FROM, MAXFORWARDS, METHOD, NEWLINE, SEPARATOR, TO, USERAGENT, VIA } from "../const/const";
